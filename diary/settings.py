...
def ensure_key(env_vars, env_path, key_name, generator):
...
DATABASES = {
    'default': {
        ...
        'NAME': get_env_path().parent / 'db.sqlite3',
    }
}
...
# if "False" entry.time will represent current time in system's local timezone
USE_TZ = False
